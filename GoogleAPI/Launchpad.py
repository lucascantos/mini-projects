...
class GoogleSlide(object):
        ...
        def drive_google(self):
                ...
                drive_service = build('drive', 'v3', http=self.client_credenciais())
        ...
        def sheets_google(self):
                ...
                sheets_service = build('sheets', 'v4', http=self.client_credenciais())
        ...
        def slides_google(self):
                ...
                logo_file = 'logo.jpg'
                drive_service = build('drive', 'v3', http=self.client_credenciais())
                slides_service = build('slides', 'v1', http=self.client_credenciais())
                ...
                slides = slides_service.presentations().get(presentationId = deck_file, fields = 'slides').execute().get('slides', [])
                pprint(slides)
                obj = None
                ...
                text = obj['shape']['text']['textElements'][1]['textRun']['content']
                ...
                credz_token = self.client_credenciais(token=True).access_token
